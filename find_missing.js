const fs = require('fs');
const topo = require('./countries-50m.json');
...
const NUM_TO_A2 = {
  ...
  "428":"LV","430":"LR","434":"LY","438":"LI","440":"LT","442":"LU","450":"MG",
  "454":"MW","458":"MY","462":"MV","466":"ML","470":"MT","478":"MR","480":"MU",
  "484":"MX","492":"MC","496":"MN","498":"MD","499":"ME","504":"MA","508":"MZ",
  "512":"OM","516":"NA","520":"NR","524":"NP","528":"NL","540":"NC","548":"VU",
  "554":"NZ","558":"NI","562":"NE","566":"NG","570":"NU","578":"NO","583":"FM",
  ...
  "862":"VE","876":"WF","882":"WS","887":"YE","894":"ZM","-99":"XK"
};

const ids = topo.objects.countries.geometries.map(g => String(g.id).padStart(3, '0'));

const missing = [];
for (const id of ids) {
    if (!NUM_TO_A2[id]) missing.push(id);
}

console.log('Missing geometries:', missing.join(', '));
