-- Fix: gold_earned in quiz_results can be negative (e.g. Nightmare quiz toll).
-- The daily gold challenge should only count gold gained, not gold spent.
-- Use GREATEST(..., 0) to clamp negative values to zero.
